...
(function () {
  ...
  var WB_PRESETS = {
    ...
    compact: {
      name: 'Compact',
      groups: [
        { id:'g1', name:'All',     icon:'✏️', mode:'flyout',  btns:['pen','magic','marker','arrow','rect','circle','triangle','pentagon','hexagon','roundrect','diamond','star','righttri','text','eraser','colors','slider','bg','zoom','undo','clear','save','load'] }
      ]
    }
  };
  ...
  var WB_IND_PRESETS = {
    default: {
      ...
      groups: [
        ...
        { id:'g3', name:'More',     icon:'➕', mode:'flyout',  btns:['text'] },
        { id:'g4', name:'Style',    icon:'🎨', mode:'inline',  btns:['colors','slider','bg'] },
        { id:'g5', name:'Actions',  icon:'⚡', mode:'inline',  btns:['undo','clear','export','save','load','zoom'] }
      ]
    },
    minimal: {
      name: 'Minimal',
      groups: [
        { id:'g1', name:'Tools',   icon:'🖊️', mode:'flyout',  btns:['pen','magic','marker','arrow','rect','circle','triangle','pentagon','hexagon','roundrect','diamond','star','righttri','text','eraser'] },
        { id:'g2', name:'Style',   icon:'🎨', mode:'inline',  btns:['colors','slider','bg'] },
        { id:'g3', name:'Actions', icon:'⚡', mode:'inline',  btns:['undo','clear','export','save','load','zoom'] }
      ]
    },
    compact: {
      name: 'Compact',
      groups: [
        { id:'g1', name:'All',     icon:'✏️', mode:'flyout',  btns:['pen','magic','marker','arrow','rect','circle','triangle','pentagon','hexagon','roundrect','diamond','star','righttri','text','eraser','colors','slider','bg','zoom','undo','clear','export','save','load'] }
      ]
    }
  };
